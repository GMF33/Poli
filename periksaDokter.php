...
// Mempersiapkan dan menjalankan kueri
...
// untuk mendapatkan hasilnya dan ambil data
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Permintaan untuk mengambil semua data dari tabel periksa
    ...
    // mendapatkan hasil dan ambil data
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($pasienData as $pasienRow) {
                                            ...
                                            // memeriksa apakah kunci 'status_periksa' ada di array $pasienRow
