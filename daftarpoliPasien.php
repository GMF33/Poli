...
if (!isset($_SESSION['nama']) || !isset($_SESSION['id'])) {
    ...
    exit(); 
} // Ini memastikan bahwa pengguna harus sudah login (sesi 'nama' dan 'id' harus ada) sebelum dapat mengakses halaman ini. Jika tidak, mereka akan diarahkan ke halaman login.

$no_rm = '';
$nama = $_SESSION['nama'];

$query = "SELECT no_rm FROM pasien WHERE nama = ?"; // Ini mengambil nomor rekam medis dari tabel 'pasien' berdasarkan nama pengguna yang sedang login.
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        } // Ini adalah formulir HTML untuk pendaftaran poliklinik. Formulir ini mencakup input untuk nomor rekam medis, 
                        // pemilihan poliklinik, pemilihan jadwal, keluhan, dan tombol "Daftar". Selain itu, ada penanganan pesan kesalahan 
                        // atau pemberitahuan berhasil setelah pendaftaran.
                        ?>
                        <form method="POST" action="">
                            ...
                            <div class="form-group">
                                ...
                                <select name="nama_poli" class="form-control" required>
                                    ...
                                    $resultPoli = $mysqli->query($queryPoli); // Ini adalah bagian yang mengambil dan menampilkan poliklinik dan 
                                    // jadwal periksa dari database ke dalam elemen <select> pada formulir.
