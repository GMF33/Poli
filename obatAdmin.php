...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update_obat_modal'])) {
  $id = $_POST['id']; // Menangani pembaruan obat dalam database menggunakan prepared statement.
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_obat'])) {
  $newNamaObat = $_POST['add_nama_obat']; // Menangani penambahan obat baru ke dalam database menggunakan prepared statement.
...
$obatQuery = "SELECT * FROM obat"; // Mengambil data obat dari tabel obat dan menyimpannya dalam bentuk array 
...
<!-- Modal digunakan untuk melakukan pembaruan obat (updateModal) dan menambahkan obat baru (addModal). -->
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
  ...
  <script>
    ...
    }); // Script JavaScript untuk menangani pembaruan konten modal ketika tombol "Update" ditekan.
  </script> 
</body>
